...
def _fixtures():
    ...
    for text in ("r1", "r2"):
        # ⚠️ ROWS USE `statement`, COLUMNS USE `label`. GridRow (courses/models.py GridRow)
        # and MultiGridRow (courses/models.py MultiGridRow) declare `statement`; only the *Column models
