...
|---|---|---|
| 1 | Dark-theme lesson body text prints at contrast **≥ 4.5:1 against `#FFFFFF`**. Correct: `--text-primary` light value, ≈15:1. Mutant: `#F2EFE9`, ≈1.1:1 | delete the `tokens.css` print override, **or** move it above the dark block at line 79 |
