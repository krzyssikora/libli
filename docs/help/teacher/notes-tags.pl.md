...
- Gdy notatki już są, użyj **Dodaj kolejną notatkę**, aby dopisać więcej.
- Każdą notatkę można edytować lub usunąć z jej karty.

Notatki pozostają przypięte do bloku, do którego należą, więc ponowne otwarcie
lekcji przywraca twoje adnotacje dokładnie tam, gdzie je zostawiłeś. Zapisana
