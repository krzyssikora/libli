...
## Cherry-picking a subset of students

Each student row has a checkbox, and the header has a **Select all students**
box. Tick the students you want and press **Apply**: the matrix recomputes for
just that subset, so the averages reflect only the students you chose. This is
ideal for checking a study group, or for comparing a handful of students on one
chapter.
...
Progress ↔ Results toggle, the Export link, and the colour-configuration link,
so you never lose your place when switching what the matrix measures.

## Per-student breakdown

Click a student's name to open their individual breakdown for the current
course. The **back** link there restores the exact scope, mode, expanded
