...
każda rola, opisuje [Użytkownicy i role](users-roles)). Wysłanie formularza
przesyła jej e-mailem link do rejestracji. Jeśli Twoja instytucja ma
skonfigurowaną listę **dozwolonych domen e-mail** (zobacz [Branding i
ustawienia platformy](branding-settings)), a podany adres jest spoza tej
listy, zaproszenie i tak zostanie wysłane, ale zobaczysz ostrzeżenie, aby
móc upewnić się, że to celowe.

## Ważność, ponowne wysyłanie i odwoływanie
...
istniejące zaproszenie (rolę i ważność) i wysyła je ponownie, zamiast
tworzyć duplikat.

## Kiedy zaproszenia nie da się wysłać

Adresu e-mail, który już należy do aktywnego konta, nie można zaprosić
