...
kreatora, aby przejść do jej **edytora**; konspekt po lewej stronie wyświetla
jej elementy w kolejności, a przycisk **+ Dodaj element** otwiera menu typów
podzielone na grupę **Treść** oraz grupę **Pytania** (tę drugą opisuje
...
- Usuń element z jego formularza edycji, gdy nie jest już potrzebny.

Każdy element ma też opcjonalny **tytuł** widoczny tylko dla autora — służy
wyłącznie do oznaczenia go w konspekcie; uczniowie nigdy go nie widzą.
...
**Ramka (iframe)** — osadza dowolną zewnętrzną stronę interaktywną poprzez
...
**Matematyka** — samodzielny blok wzoru w trybie wyświetlanym. Wpisz LaTeX;
...
- Preferuj Tekst dla wszystkiego, co jest głównie prozą; sięgaj po
  Matematykę lub HTML tylko wtedy, gdy potrzebujesz ich konkretnej
  możliwości.
